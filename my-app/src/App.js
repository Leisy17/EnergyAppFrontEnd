...
import './App.css';
import energyapp from './assets/imgs/energyapp1.png';
function App() {
  return (
    <div className="App">
<head>
        ...
        <meta name="description" content="Tesis parte Frontend de Leisy Sánchez: EnergyApp" />
        <meta name="author" content="Leisy Dorissa Sánchez Doria" />
        <title>EnergyApp</title>
        {/*<!-- Favicon-->*/}
        <link rel="icon" type="image/x-icon" href="imagenes/letra-e.png" />
        {/*<!-- Bootstrap icons-->*/}
        ...
        <main className="flex-shrink-0">
            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container px-5">
                    <a className="navbar-brand" href="index.html"><img className="img-fluid rounded-3 my-5" src={energyapp} alt="..." /></a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item"><a className="nav-link" href="pricing.html">Contacto</a></li>
                            <li className="nav-item"><a className="nav-link" href="faq.html">Acceder</a></li>
                    ...
                    <div className="row gx-5 align-items-center justify-content-center">
                        <div className="col-lg-8 col-xl-7 col-xxl-6">
                            <div className="my-5 text-center text-xl-start">
                                <h1 className="display-5 fw-bolder text-white mb-2">Gestiona el uso de la Energía  en tu Planta</h1>
                                <p className="lead fw-normal text-white-50 mb-4">Sólo inserta tus datos de consumo/producción y con  un par de clicks encontrarás el análisis energético</p>
                                <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a className="btn btn-primary btn-lg px-4 me-sm-3" href="#!">Inicia aquí</a>
                                    <a className="btn btn-outline-light btn-lg px-4" href="#features">Aprender más</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="d-flex align-items-end justify-content-between">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="small">
                                                ...
                                                <div className="text-muted">March 23, 2021 &middot; 4 min read</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="d-flex align-items-end justify-content-between">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="small">
                                                ...
                                                <div className="text-muted">April 2, 2021 &middot; 10 min read</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="py-5" id="features">
                <div className="container px-5 my-5">
                    <div className="row gx-5">
                        <div className="col-lg-4 mb-5 mb-lg-0"><h2 class="fw-bolder mb-0">A better way to start building.</h2></div>
                        <div className="col-lg-8">
                            <div className="row gx-5 row-cols-1 row-cols-md-2">
                                <div className="col mb-5 h-100">
                                    <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-collection"></i></div>
                                ...
                                <div className="col mb-5 h-100">
                                    <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-building"></i></div>
                                    <h2 className="h5">Featured title</h2>
                                    <p className="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
                                </div>
                                <div className="col mb-5 mb-md-0 h-100">
                                    <div className="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                                    <h2 className="h5">Featured title</h2>
                                    <p className="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
                                </div>
        ...
        <footer className="bg-dark py-4 mt-auto">
            <div className="container px-5">
                <div className="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div className="col-auto"><div class="small m-0 text-white">Copyright &copy; Universidad del Atlántico 2021</div></div>
